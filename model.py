...
def run_style_transfer(content_img, style_img, input_img=input_img, cnn=cnn, 
    ...
    # a last correction...
    input_img = input_img.squeeze(0).permute(1, 2, 0).clamp_(0, 1)
